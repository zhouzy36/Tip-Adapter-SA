...
"""
Examples:
python save_MyCLIP_FF_features.py --dataset coco2014 features/coco2014/MyCLIP_FF/val_all.pt
python save_MyCLIP_FF_features.py --dataset voc2012 features/voc2012/MyCLIP_FF/val_all.pt

python save_MyCLIP_FF_features.py --dataset coco2014 --split-file splits/coco2014/exp1/1shots_filtered.txt features/coco2014/MyCLIP_FF/exp1_1shots_filtered.pt
python save_MyCLIP_FF_features.py --dataset voc2012 --split-file splits/voc2012/exp1/1shots_filtered.txt features/voc2012/MyCLIP_FF/exp1_1shots_filtered.pt
"""
