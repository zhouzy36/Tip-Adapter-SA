...
# newly added
def encode_text_with_prompt_ensemble(model, classnames, device, prompt_templates=None):
    """Return classifier weights created by class names and prompt templates
    Args:
        model (CLIP): clip model
        classnames (list): class name list
        device (torch.device): device
    Returns:
        text_features (Tensor): text features with size [N, D]
    """
